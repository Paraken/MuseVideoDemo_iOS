...
@interface MuseVideoMediaConfigBase : NSObject
...
/// 水印大小.
@property (nonatomic)           CGSize                              watermarkSize;
...
@interface MuseVideoCameraConfig : MuseVideoMediaConfigBase
...
@interface MuseVideoPhotoConfig : MuseVideoMediaConfigBase

/// 拍摄页是否显示闪光灯选择开关, 默认显示.
@property (nonatomic, assign)   BOOL                                enableFlashSwitch;
